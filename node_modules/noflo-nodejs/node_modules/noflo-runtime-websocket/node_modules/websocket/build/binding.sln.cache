<Project DefaultTargets="Build" ToolsVersion="3.5" InitialTargets="ValidateSolutionConfiguration;ValidateToolsVersions" xmlns="http://schemas.microsoft.com/developer/msbuild/2003">
  ...
  <PropertyGroup Condition=" ('$(Configuration)' == 'Debug') and ('$(Platform)' == 'x64') ">
    <CurrentSolutionConfigurationContents>
      <SolutionConfiguration xmlns="">
        <ProjectConfiguration Project="{E3074A53-FE90-B1B9-7BB1-99381047F3FD}">Debug|x64</ProjectConfiguration>
        <ProjectConfiguration Project="{B29AC4E6-4A16-9DF8-80C2-AD306B3AE3AE}">Debug|x64</ProjectConfiguration>
  ...
  <PropertyGroup Condition=" ('$(Configuration)' == 'Release') and ('$(Platform)' == 'x64') ">
    <CurrentSolutionConfigurationContents>
      <SolutionConfiguration xmlns="">
        <ProjectConfiguration Project="{E3074A53-FE90-B1B9-7BB1-99381047F3FD}">Release|x64</ProjectConfiguration>
        <ProjectConfiguration Project="{B29AC4E6-4A16-9DF8-80C2-AD306B3AE3AE}">Release|x64</ProjectConfiguration>
      </SolutionConfiguration>
    </CurrentSolutionConfigurationContents>
  </PropertyGroup>
  ...
  <Target Name="bufferutil" Condition="'$(CurrentSolutionConfigurationContents)' != ''">
    ...
    <VCBuild Projects="C:\Users\Josi\OneDrive\Synthace\my-noflo-example-app\node_modules\noflo-nodejs\node_modules\noflo-runtime-websocket\node_modules\websocket\build\bufferutil.vcproj" ToolPath="$(VCBuildToolPath)" Configuration="Debug|x64" SolutionFile="C:\Users\Josi\OneDrive\Synthace\my-noflo-example-app\node_modules\noflo-nodejs\node_modules\noflo-runtime-websocket\node_modules\websocket\build\binding.sln" Override="$(VCBuildOverride)" AdditionalLibPaths="$(VCBuildAdditionalLibPaths)" AdditionalLinkLibraryPaths="$(VCBuildAdditionalLinkLibraryPaths)" UseEnvironment="$(VCBuildUseEnvironment)" UserEnvironment="$(VCBuildUserEnvironment)" AdditionalOptions="$(VCBuildAdditionalOptions)" Condition=" ('$(Configuration)' == 'Debug') and ('$(Platform)' == 'x64') " />
    <CreateProperty Value="C:\Program Files (x86)\Microsoft Visual Studio 9.0\Common7\IDE\..\..\vc\vcpackages" Condition="'$(VCBuildToolPath)' == ''">
      <Output TaskParameter="Value" PropertyName="VCBuildToolPath" />
    </CreateProperty>
    <VCBuild Projects="C:\Users\Josi\OneDrive\Synthace\my-noflo-example-app\node_modules\noflo-nodejs\node_modules\noflo-runtime-websocket\node_modules\websocket\build\bufferutil.vcproj" ToolPath="$(VCBuildToolPath)" Configuration="Release|x64" SolutionFile="C:\Users\Josi\OneDrive\Synthace\my-noflo-example-app\node_modules\noflo-nodejs\node_modules\noflo-runtime-websocket\node_modules\websocket\build\binding.sln" Override="$(VCBuildOverride)" AdditionalLibPaths="$(VCBuildAdditionalLibPaths)" AdditionalLinkLibraryPaths="$(VCBuildAdditionalLinkLibraryPaths)" UseEnvironment="$(VCBuildUseEnvironment)" UserEnvironment="$(VCBuildUserEnvironment)" AdditionalOptions="$(VCBuildAdditionalOptions)" Condition=" ('$(Configuration)' == 'Release') and ('$(Platform)' == 'x64') " />
  </Target>
  ...
  <Target Name="validation" Condition="'$(CurrentSolutionConfigurationContents)' != ''">
    ...
    <VCBuild Projects="C:\Users\Josi\OneDrive\Synthace\my-noflo-example-app\node_modules\noflo-nodejs\node_modules\noflo-runtime-websocket\node_modules\websocket\build\validation.vcproj" ToolPath="$(VCBuildToolPath)" Configuration="Debug|x64" SolutionFile="C:\Users\Josi\OneDrive\Synthace\my-noflo-example-app\node_modules\noflo-nodejs\node_modules\noflo-runtime-websocket\node_modules\websocket\build\binding.sln" Override="$(VCBuildOverride)" AdditionalLibPaths="$(VCBuildAdditionalLibPaths)" AdditionalLinkLibraryPaths="$(VCBuildAdditionalLinkLibraryPaths)" UseEnvironment="$(VCBuildUseEnvironment)" UserEnvironment="$(VCBuildUserEnvironment)" AdditionalOptions="$(VCBuildAdditionalOptions)" Condition=" ('$(Configuration)' == 'Debug') and ('$(Platform)' == 'x64') " />
    <CreateProperty Value="C:\Program Files (x86)\Microsoft Visual Studio 9.0\Common7\IDE\..\..\vc\vcpackages" Condition="'$(VCBuildToolPath)' == ''">
      <Output TaskParameter="Value" PropertyName="VCBuildToolPath" />
    </CreateProperty>
    <VCBuild Projects="C:\Users\Josi\OneDrive\Synthace\my-noflo-example-app\node_modules\noflo-nodejs\node_modules\noflo-runtime-websocket\node_modules\websocket\build\validation.vcproj" ToolPath="$(VCBuildToolPath)" Configuration="Release|x64" SolutionFile="C:\Users\Josi\OneDrive\Synthace\my-noflo-example-app\node_modules\noflo-nodejs\node_modules\noflo-runtime-websocket\node_modules\websocket\build\binding.sln" Override="$(VCBuildOverride)" AdditionalLibPaths="$(VCBuildAdditionalLibPaths)" AdditionalLinkLibraryPaths="$(VCBuildAdditionalLinkLibraryPaths)" UseEnvironment="$(VCBuildUseEnvironment)" UserEnvironment="$(VCBuildUserEnvironment)" AdditionalOptions="$(VCBuildAdditionalOptions)" Condition=" ('$(Configuration)' == 'Release') and ('$(Platform)' == 'x64') " />
  </Target>
